...
INSERT INTO accounts
	...
	VALUES
	('D', 'Plant', 'd@plantme.com', '$2a$11$Qs5QuF6Y5ihMU758PPZMleWxuYvFrLkyE2i0Gl00pqYbMfFt6voYC', 'ADMIN'),
	('L', 'Test', 't@test.com', '$2a$11$Qs5QuF6Y5ihMU758PPZMleWxuYvFrLkyE2i0Gl00pqYbMfFt6voYC', 'USER'),
	('D', 'Test', 'd@test.com', '$2a$11$Qs5QuF6Y5ihMU758PPZMleWxuYvFrLkyE2i0Gl00pqYbMfFt6voYC', 'USER');
...
INSERT INTO account_plants
	(account_id, plant_id)
	VALUES
	((SELECT a.id FROM accounts a WHERE a.email = 't@test.com'),
	(SELECT p.id FROM plants p WHERE p.plant_code = 'PL1')),
	((SELECT a.id FROM accounts a WHERE a.email = 't@test.com'),
	(SELECT p.id FROM plants p WHERE p.plant_code = 'PL3')),
	((SELECT a.id FROM accounts a WHERE a.email = 't@test.com'),
	(SELECT p.id FROM plants p WHERE p.plant_code = 'PL5')),
	((SELECT a.id FROM accounts a WHERE a.email = 'd@test.com'),
	(SELECT p.id FROM plants p WHERE p.plant_code = 'PL1'));